...
import WorkshopBand from "@/components/gallery/WorkshopBand";
 ...
 * compressed to a row of four room tiles, the workshop band, the four
 * assurances, collector words, then the manifesto and the closing
 * invitation. Every image slot falls back to a generative visual, so the
 * page reads deliberate before a single photograph exists.
 */
export default async function Home() {
  ...
  return (
    <main>
      ...
      <WorkshopBand
        image={settings.workshopImage}
        alt={settings.workshopAlt}
      />
