...
lib/
  chairs.ts               the sixteen silhouettes, generated by `npm run chairs`
                          from public/Asset *.svg; do not edit by hand
  physics.ts              oriented-box solver: SAT, sequential impulses, warm
                          starting. Pure and DOM-free, used by the splash
```
