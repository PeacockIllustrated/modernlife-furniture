...
- Type: two faces, the pairing the mark is built from. Montserrat states (headings, body, labels); Anaktoria accents, the calligraphic hand that sets the "of" in the lockup and here sets the one emphasised word in a heading (the "Love is *personal*" pattern). Anaktoria has one weight and no italic: never embolden or slant it, change the face instead. Sentence case everywhere, including nav and buttons.
